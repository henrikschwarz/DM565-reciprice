...
show an estimated of the cost of making the recipe. The cost of the different ingredients can be
...
offers of local chains.  This price information can be used to let the users query recipes
based on their specific budgets. Another way for the
product to utilize the price information, is that the user can input their current owned
ingredients, and get suggestions on  recipes of which the user is only missing a
